...
const Vote = createLucideIcon("vote", __iconNode$1);
/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function CardTitle({ className, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "h4",
    {
      ...
      className: cn$1("leading-none", className),
      ...props
    }
  );
}
function CardContent({ className, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      className: cn$1("px-6 [&:last-child]:pb-6", className),
      ...props
    }
  );
}
const mockElectoralData = {
  presidencial: {
    department: "LIMA",
    province: "LIMA",
...
const saveActiveCategory = (category) => {
...
function ElectoralCountTable({ data, category, selectedLocation }) {
  ...
  const calculateVoteData = () => {
    ...
    voteEntries.forEach((entry) => {
      if (entry.party) {
        voteCount2[entry.party] = (voteCount2[entry.party] || 0) + 1;
    ...
    return { voteCount: voteCount2, matrix };
  };
  ...
  const calculateStatistics = () => {
    ...
    const totalValidVotes = Object.entries(voteCount).filter(([party]) => party !== "BLANCO" && party !== "NULO").reduce((sum, [, count2]) => sum + count2, 0);
    const totalVotesEmitted = totalValidVotes;
    const totalVotersWhoVoted = totalValidVotes + blankAndNullVotes;
    const participationRate = data.totalEligibleVoters > 0 ? totalVotersWhoVoted / data.totalEligibleVoters * 100 : 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "text-white h-6", style: { backgroundColor: "oklch(0.5200 0.2100 15)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-16 text-center font-semibold text-white py-1 h-6", rowSpan: 2, children: "CÓDIGO" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-white py-1 h-6", rowSpan: 2, style: { width: "auto", minWidth: "250px", maxWidth: "300px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: "ORGANIZACIÓN POLÍTICA" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-center font-semibold text-white py-1", rowSpan: 2, style: { width: "80px", minWidth: "80px", maxWidth: "80px", whiteSpace: "normal", lineHeight: "1.2", fontSize: "0.80rem" }, children: "TOTAL DE VOTOS" }),
          showPreferentialColumns && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-center font-semibold text-white border-l-2 border-white py-1 h-6", colSpan: 30, children: "VOTO PREFERENCIAL" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-20 text-center font-semibold text-white border-l-2 border-white py-1 h-6", rowSpan: 2, children: "TOTAL VP" })
          ] })
        ] }),
        showPreferentialColumns && /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "text-white h-6", style: { backgroundColor: "oklch(0.5200 0.2100 15)" }, children: Array.from({ length: 30 }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-8 text-center font-semibold text-red-600 bg-gray-300 text-xs px-1 py-0 h-6", children: i + 1 }, i + 1)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: politicalOrganizations.map((org, index2) => {
        const partyKey = org.order ? `${org.order} | ${org.name}` : org.name;
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: `${index2 % 2 === 0 ? "bg-white" : "bg-gray-50"} h-6`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center font-medium py-1", children: org.order || "-" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-1", style: { width: "150px", minWidth: "150px", maxWidth: "150px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, title: org.name, children: org.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center font-semibold py-1", children: totalVotes }),
          showPreferentialColumns && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: isBlancoOrNulo ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            TableCell,
            {
              colSpan: 31,
            ...
            Array.from({ length: 30 }, (_, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                TableCell,
                {
                  className: `w-8 text-center text-xs px-1 py-1 border-l border-gray-200 ${isNonZero ? "text-red-600 bg-green-100" : ""}`,
                  children: value
                },
                i + 1
              );
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "w-20 text-center font-semibold border-l-2 border-gray-300 py-1", children: partyMatrix ? partyMatrix.total || 0 : 0 })
          ] }) })
...
function VoteEntryForm({ category, existingEntries = [], voteLimits, preferentialConfig, onEntriesChange }) {
  const [entries, setEntries] = reactExports.useState(existingEntries);
  reactExports.useEffect(() => {
  ...
  const [editingTableNumber, setEditingTableNumber] = reactExports.useState(null);
  const [originalEntry, setOriginalEntry] = reactExports.useState(null);
  ...
  const handleConfirmEdit = () => {
    ...
    const updatedEntries = entries.map(
      (entry) => entry.tableNumber === editingTableNumber ? updatedEntry : entry
    );
    updateEntries(updatedEntries);
...
function PoliticalOrganizations({ category, voteLimits, onVoteLimitsChange, preferentialConfig }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "text-white", style: { backgroundColor: "oklch(0.5200 0.2100 15)" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-white w-20 text-center font-semibold", children: "ORDEN" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-white font-semibold", children: "ORGANIZACIÓN POLÍTICA" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: politicalOrganizations.map((org, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: index2 % 2 === 0 ? "bg-white" : "bg-gray-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center font-medium", children: org.order }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-3", children: org.name })
      ] }, org.key)) })
    ] }) }) }),
    (preferentialConfig.hasPreferential1 || preferentialConfig.hasPreferential2) && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Configuración de Límites de Votos Preferenciales" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `grid grid-cols-1 gap-6 ${preferentialConfig.hasPreferential1 && preferentialConfig.hasPreferential2 ? "md:grid-cols-2" : ""}`, children: [
          preferentialConfig.hasPreferential1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
                htmlFor: "pref1-limit",
                className: "text-sm font-medium mb-2 block text-gray-700 cursor-pointer",
                children: "Límite Voto Preferencial 1"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Rango válido: 1 - 199" })
          ] }),
          preferentialConfig.hasPreferential2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
                htmlFor: "pref2-limit",
                className: "text-sm font-medium mb-2 block text-gray-700 cursor-pointer",
                children: "Límite Voto Preferencial 2"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-blue-900 mb-2", children: "Límites Configurados Actualmente" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `grid gap-4 ${preferentialConfig.hasPreferential1 && preferentialConfig.hasPreferential2 ? "grid-cols-2" : "grid-cols-1"}`, children: [
            preferentialConfig.hasPreferential1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-blue-100 text-blue-800 border-blue-300", children: "Voto Pref. 1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-blue-900", children: voteLimits.preferential1 })
            ] }),
            preferentialConfig.hasPreferential2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-blue-100 text-blue-800 border-blue-300", children: "Voto Pref. 2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-blue-900", children: voteLimits.preferential2 })
            ] })
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Información Adicional" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 p-4 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-semibold text-blue-900", children: politicalOrganizations.length }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-blue-700", children: "Organizaciones Registradas" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 p-4 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-semibold text-green-900", children: "Activo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-green-700", children: "Estado del Proceso" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-50 p-4 rounded-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-semibold text-yellow-900", children: "2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-yellow-700", children: "Año Electoral" })
        ] })
      ] }) })
    ] })
  ] });
}
const logoJne = "" + new URL("../logo_jne.svg", import.meta.url).href;
const csvFile = "" + new URL("../TB_UBIGEOS.csv", import.meta.url).href;
function ElectoralDashboard() {
  const [activeCategory, setActiveCategory] = reactExports.useState(() => getActiveCategory());
  const [categoryData, setCategoryData] = reactExports.useState(() => getAllCategoryData());
  const [ubigeoData, setUbigeoData] = reactExports.useState([]);
  const [selectedDepartamento, setSelectedDepartamento] = reactExports.useState("");
  const [selectedProvincia, setSelectedProvincia] = reactExports.useState("");
  const [selectedDistrito, setSelectedDistrito] = reactExports.useState("");
  reactExports.useEffect(() => {
  ...
  const updateCurrentCategoryData = (updates) => {
  ...
  const getPreferentialVoteConfig = (category) => {
    switch (category) {
      case "presidencial":
  ...
  const sections = [
    ...
    { key: "recuento", label: "Recuento", icon: ChartColumn },
  ...
  const getDistritos = (departamento, provincia) => {
    ...
    const filtered = ubigeoData.filter(
      (record) => record.departamento === departamento && record.provincia === provincia
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-white border-b border-gray-200 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3 flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoJne, className: "w-8 h-8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-gray-900", children: "Recuento de Votos" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: activeCategory, onValueChange: setActiveCategory, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-44", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: categories.map((category) => {
            const Icon2 = category.icon;
            return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: category.key, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: category.label })
            ] }) }, category.key);
          }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: activeSection, onValueChange: (section) => updateCurrentCategoryData({ activeSection: section }), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: sections.map((section) => {
            const Icon2 = section.icon;
            return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: section.key, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: section.label })
            ] }) }, section.key);
          }) })
        ] }),
        showLocationDropdowns && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: selectedDepartamento, onValueChange: handleDepartamentoChange, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Departamento" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: getDepartamentos().map((dept) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: dept, children: dept }, dept)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Provincia" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: getProvincias(selectedDepartamento).map((prov) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: prov, children: prov }, prov)) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Distrito" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: getDistritos(selectedDepartamento, selectedProvincia).map((dist) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: dist, children: dist }, dist)) })
              ]
            }
          )
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "w-full px-4 sm:px-6 lg:px-8 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: renderSection() }) })
  ] });
}
